...
\begin{figure}[H]
    \centering
    % \includegraphics[width=1\textwidth]{report/images/ảnh-camera-ai.png}
    \rule{1\textwidth}{8cm} 
    \caption{AI vẽ khung xương Neon lên người dùng. Khung viền và Text chuyển ĐỎ khi phát hiện Vẹo lưng}
\end{figure}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=1\textwidth]{report/images/ảnh-dashboard.png}
    \rule{1\textwidth}{8cm} 
    \caption{Biểu đồ phân bổ tỷ lệ sai tư thế được vẽ bằng Chart.js}
\end{figure}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=1\textwidth]{report/images/ảnh-chat-gamification.png}
    \rule{1\textwidth}{8cm} 
    \caption{Khối lượng tính năng Social (Gamification, Nhiệm vụ, Đồng hồ Pomodoro, Phòng học Ảo)}
\end{figure}
